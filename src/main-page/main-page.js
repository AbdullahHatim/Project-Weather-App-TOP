...
async function showWeatherInfo (event) {
  ...
  try {
    ...
    appendCountryFlag(locationAddressDiv)
...
// Country Flag Appender
async function appendCountryFlag (element) {
  try {
    ...
    const countryName = searchInput.value // Or potentially extract from weather data if passed
